...
$_SGLOBAL['openidlang'] = array(
	'openid_login' => '登录',
	'submit' => '提交',
	'openid_intro' => '<a href="http://openid.enjoyoung.cn/help" target=_blank>1.什么是星尚通行证？</a>',
	'openid_guide' => '<a href="http://openid.enjoyoung.cn/passwords/troubleshooting" target=_blank>2.登录帮助</a>',
	'openid_sites' => '<a href="http://openid.enjoyoung.cn/passwords/troubleshooting" target=_blank>3.星尚旗下网站</a>',
	'openid_auth' => '认证中……',
	'openid_add' => '添加',
	'openid_del' => '删除',
	...
	'bind_intro_login' => "1.点击“<a href=$link_login><font color=red>登录绑定</font></a>”进入到登录界面，登录成功再进入此页面后自动与当前OpenID绑定",
	'bind_intro_reg' => "2.点击“<a href=$link_register><font color=red>注册绑定</font></a>”进入到注册界面，注册成功再进入此页面后自动与当前OpenID绑定",
