...
class Auth_OpenID_MySQLStore extends Auth_OpenID_SQLStore {
    ...
    function setSQL()
    {
        $this->sql['nonce_table'] =
            "CREATE TABLE %s (\n".
            "  server_url VARCHAR(255) NOT NULL,\n".//wukan:VARCHAR(2047)->VARCHAR(255)
            "  timestamp INTEGER NOT NULL,\n".
            "  salt CHAR(40) NOT NULL,\n".
            "  UNIQUE (server_url(200), timestamp, salt)\n".//wukan:255 -> 200
            ") ENGINE=InnoDB";//wukan:ENGINE=InnoDB -> TYPE=InnoDB

        $this->sql['assoc_table'] =
            "CREATE TABLE %s (\n".
            "  server_url BLOB NOT NULL,\n".//wukan:BLOB -> VARCHAR(255)
            "  handle VARCHAR(255) NOT NULL,\n".
            "  secret BLOB NOT NULL,\n".
            "  issued INTEGER NOT NULL,\n".
            "  lifetime INTEGER NOT NULL,\n".
            "  assoc_type VARCHAR(64) NOT NULL,\n".
            "  PRIMARY KEY (server_url(200), handle)\n".//wukan:255 -> 200
            ") ENGINE=InnoDB";//wukan:ENGINE=InnoDB -> TYPE=InnoDB
